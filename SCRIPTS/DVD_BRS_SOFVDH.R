...
system(" mkdir /home/aakumar/WORK/LINK_ANAL/DVD_BRS/DBIE_inputfiles")
...
# DBIE
dbie.cols<-grep("^DBIE",names(Data))
...
for(i in 1:n.chr){
  ...
  write.table(mapfile[[i]],paste("/home/aakumar/WORK/LINK_ANAL/DVD_BRS/DBIE_inputfiles/map.",i,sep=""), quote=F,row.names=F,sep="\t")
}
...
raw.pre<-read.table("/home/aakumar/WORK/LINK_ANAL/DVD_BRS/PED/DBIE_Ped_file_2.csv",header=F,sep="\t")
#pre.6<-raw.pre[,-7]
