...
system(" mkdir /home/aakumar/WORK/LINK_ANAL/DVD_BRS/DBEC_inputfiles")
...
# DBEC
vass.cols <-grep("^DBEC",names(Data))
...
for(i in 1:n.chr){
  ...
  #write.table(mapfile[[i]],paste("DBEC_inputfiles/map.",i,sep=""), quote=F,row.names=F,sep="\t")
  write.table(mapfile[[i]],paste("/home/aakumar/WORK/LINK_ANAL/DVD_BRS/DBEC_inputfiles/map.",i,sep=""), quote=F,row.names=F,sep="\t")
}
...
for (i in 1:n.chr){
  ...
  write.table(namesfile[[i]],paste("/home/aakumar/WORK/LINK_ANAL/DVD_BRS/DBEC_inputfiles/names.",i,sep=""), quote=F,row.names=F,col.names=F,sep="\t")
}
...
raw.pre<-read.table("/home/aakumar/WORK/LINK_ANAL/DVD_BRS/PED/DBEC_Ped_file.csv",header=F,sep="\t")
#pre.6<-raw.pre[,-7]
...
DBEC_11 <-matrix(NA,nrow=n.snp,ncol=1)
DBEC_12 <-matrix(NA,nrow=n.snp,ncol=1)
DBEC_21 <-matrix(NA,nrow=n.snp,ncol=1)
DBEC_24 <-matrix(NA,nrow=n.snp,ncol=1)
DBEC_25 <-matrix(NA,nrow=n.snp,ncol=1) #
DBEC_34 <-matrix(NA,nrow=n.snp,ncol=1) #



#empty<-as.data.frame(cbind(KIV_000025,KIV_000028))
empty<-as.data.frame(cbind(DBEC_11, DBEC_12, DBEC_21, DBEC_24, DBEC_25,DBEC_34))
#names(empty)<-c("KIV_000025","KIV_000028")
#names(empty)<-c("DBEC_11","DBEC_12","DBEC_21","DBEC_24","DBEC_26","DBEC_27","DBEC_210","DBEC_212","DBEC_311")
names(empty)<-c("DBEC_11", "DBEC_12","DBEC_21","DBEC_24","DBEC_25","DBEC_34") 
...
for (i  in 1:n.chr){
	...
	write.table(prefile[[i]],file=paste("/home/aakumar/WORK/LINK_ANAL/DVD_BRS/DBEC_inputfiles/pedin.",i,sep=""),sep="\t", quote=F,row.names=F,col.names=F,na="0")
}

system("cp -r /home/aakumar/WORK/LINK_ANAL/DVD_BRS/DBEC_inputfiles  /home/aakumar/WORK/LINK_ANAL/DVD_BRS/ORIG_DBEC_inputfiles")
system("cp /home/aakumar/WORK/LINK_ANAL/DVD_BRS/PAR/* /home/aakumar/WORK/LINK_ANAL/DVD_BRS/DBEC_inputfiles/")
